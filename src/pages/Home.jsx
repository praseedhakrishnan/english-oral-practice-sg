...
function Home() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Hero banner */}
      <div className="bg-gradient-to-br from-red-600 to-red-700 text-white rounded-2xl p-8 text-center shadow-lg">
        <div className="text-5xl mb-3">🇸🇬</div>
        <h1 className="text-3xl font-bold mb-2">English Oral Practice SG</h1>
        <p className="text-red-100 text-lg">Practise PSLE English Oral with AI Feedback</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link
          to="/reading"
          className="bg-white border-2 border-red-100 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-red-300 transition-all group"
        >
          <div className="text-4xl mb-3">📖</div>
          <h2 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-red-600 transition-colors">Reading Aloud</h2>
          ...
          <div className="mt-4 inline-block bg-red-50 text-red-600 text-sm font-semibold px-3 py-1 rounded-lg">
            Start Practising →
          </div>
        </Link>
        ...
        >
          <div className="text-4xl mb-3">🎤</div>
          <h2 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-red-600 transition-colors">Stimulus-Based Conversation</h2>
      ...
      {recentSessions.length > 0 && (
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-200">
          ...
          <Link to="/progress" className="block text-center text-red-600 text-sm font-medium mt-3 hover:underline">
            View all progress →
          </Link>
        </div>
      )}
